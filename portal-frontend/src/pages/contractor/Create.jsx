...
const Create = () => {
    ...
    useEffect(() => {
        axios.get(`contractors/${id}/dashboard`)
            .then(response => {
        ...
        <>
            <div className="content-container">
                ...
                <table>
                    ...
                    <tbody>
                        {contractor && contractor.jobs.map((job, index) => (
                            <tr key={index}>
                                <td>{job.title}</td>
                                ...
                                <td className='edit'>
                                    <span className="edit_span">
                                        <Link className="edit_link" to={`edit/${job._id}`} >Edit</Link>
                                    </span>
                                    <span className="delete_span">
                                        <Link className="delete_link" to='#' onClick={() => handleDelete(job._id)} >Delete</Link>
                                    </span>
                                </td>
                            </tr>
                        ))}
